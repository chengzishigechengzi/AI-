(function overrideHomePageV4(global) {
  const homeMarkup = `
    <section class="home-ref" aria-label="首页工作台">
      <header class="home-ref__hero" aria-labelledby="home-hero-title">
        <h1 id="home-hero-title" class="home-ref__hero-title">AI可用性分析</h1>
      </header>

      <div class="home-ref__content">
        ...
        <section class="home-ref-main" aria-labelledby="home-ref-title">
          ...
          <div class="home-ref-main__actions">
            <button class="home-ref-test-card home-ref-test-card--page" type="button" data-route="page-test" aria-label="进入页面测试">
              <span class="home-ref-test-card__badge" aria-hidden="true">
                <span class="home-ref-test-card__icon">
              ...
              <span class="home-ref-test-card__content">
                <span class="home-ref-test-card__title">页面测试</span>
                <span class="home-ref-test-card__text">测试单个页面的用户体验</span>
              </span>
            </button>

            <button class="home-ref-test-card home-ref-test-card--flow" type="button" data-route="flow-test" aria-label="进入流程测试">
              <span class="home-ref-test-card__badge" aria-hidden="true">
                <span class="home-ref-test-card__icon">
                  <svg viewBox="0 0 24 24" focusable="false">
              ...
              <span class="home-ref-test-card__content">
                <span class="home-ref-test-card__title">流程测试</span>
